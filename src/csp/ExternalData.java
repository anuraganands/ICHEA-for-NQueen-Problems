...
public abstract class ExternalData implements Cloneable, Serializable {
    ...
    protected static ArrayList<Integer> dynConsList = new ArrayList<Integer>();
...
//    public abstract ArrayList<Double> negateVal(ArrayList<Double> val);
     ...
     */
    protected abstract ArrayList<Chromosome> initializeExternalChrmosomes(final int population) throws SolutionFoundException; //, final boolean bInitialStage);
...
//            final Idx2D[] valVsConstIdx, int []grpSwap);
    ...
    public abstract void addTabuConstraint(ArrayList<ArrayList> localOptList);
